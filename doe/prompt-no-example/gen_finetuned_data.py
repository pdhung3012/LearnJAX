...
def build_data_for_fine_tuning(item: Dict[str, Any]) -> Dict[str, str]:
    ...
    # print(json_str)
    # input('aaaa')
    user_prompt = SamplePromptTemplate.prompt_template.replace("{INPUT_XML}", json_str)
...
fp_output_train='/home/hungphd/git/LearnJAX/doe/data-all/label-split/finetune_noex_train.csv'
fp_label_valid='/home/hungphd/git/LearnJAX/doe/data-all/label-split/valid.json'
fp_output_valid='/home/hungphd/git/LearnJAX/doe/data-all/label-split/finetune_noex_valid.csv'
