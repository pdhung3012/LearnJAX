...
def process_items_vllm(
    ...
    *,
    ...
    llm = LLM(
        ...
        tokenizer=fp_local_model,           # ensure tokenizer matches
        dtype=dtype,
...
if __name__ == "__main__":
    fp_local_model = "/home/hungphd/git/CodeLlama-7b-Instruct-hf/"  # e.g., "/models/Llama-3.1-8B-Instruct"
    fop_output_result='/home/hungphd/git/POTracker_FinalVersion/preprocess-dataset/output_v1/'
    fp_output=fop_output_result+'test.json'
    fp_input_file='/home/hungphd/git/POTracker_FinalVersion/preprocess-dataset/finetune_gpt-5-mini/test.json'
