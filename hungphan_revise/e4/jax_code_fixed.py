...
def main():
    ...
    key = random.PRNGKey(42)  # FIXED: Changed from 0 to 42
    ...
    # FIXED: Extract scalar values and format output to match PyTorch
    learned_w = model.params['w'][0, 0]
    learned_b = model.params['b'][0]
