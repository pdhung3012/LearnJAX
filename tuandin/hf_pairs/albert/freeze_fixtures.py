"""Freeze fixtures for the ALBERT case (symmetric design)."""
import json
import sys
...
from transformers import AlbertConfig as HFConfig, AlbertModel as HFModel
